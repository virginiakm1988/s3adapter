...
def get_downstream_args():
    ...
    ### prompt tuning
    parser.add_argument(
        "--prompt", nargs=1, default="None", choices=["None", "prefix", "preinput"]
    )
    parser.add_argument("--prompt_len", type=int, default=10)
    parser.add_argument("--prompt_init", type=str2bool, default=False)
    parser.add_argument(
        "--task", type=str, default="None", help="For prompt init (IC, ASR, PR, SF)"
    )
    ...
    if args.past_exp:
        ...
        # if args.prime:
        #     # Add none overwrite args here
        #     # Some args should not be overwritten by previous args during prime
        #     # Ex. downstream will be change every time
        #     cannot_overwrite_args_prime = [
        #         'downstream', 'prime_seed', 'task',
        #         '',
        #     ]
        #     cannot_overwrite_args.extend(cannot_overwrite_args_prime)
...
def main():
    ...
    if args.prime:
        args.mode = f'{args.downstream}_{args.mode}'
